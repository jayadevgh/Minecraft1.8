...
public class myEventHandler implements IWorldGenerator
{
    @Override
    ...
    {
           addOreSpawn(Main.jadeOre.getDefaultState(), Blocks.stone, world, random, x, z, 16, 16, 5 + random.nextInt(5), 4, 20, 60);
    }
     ...
     *            int for the maximum Y-Coordinate height at which this block
                    may spawn
     **/
    public void addOreSpawn(IBlockState block, Block target, World world, Random
      random, int blockXPos, int blockZPos, int maxX, int maxZ, int maxVeinSize,
